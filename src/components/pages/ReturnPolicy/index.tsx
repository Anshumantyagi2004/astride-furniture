    ...
    <main className="bg-[#F8F9FA] text-[#161316] min-h-screen pb-24" style={{ fontFamily: '"Inter", sans-serif' }}>
      ...
      <div className="bg-[#161316] text-white py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Please read our return and eligibility guidelines carefully.
          </motion.p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 mt-16 space-y-8">
        ...
        >
          <h3 className="text-xl font-bold text-zinc-900 uppercase tracking-tight mb-4">
            Can I return an item ordered from Astride?
          </h3>
          <p className="text-zinc-600 text-base leading-relaxed font-light mb-4">
            All sales are generally <strong className="font-semibold text-zinc-950">non-returnable and non-refundable</strong>.
          </p>
          <p className="text-zinc-600 text-base leading-relaxed font-light mb-4">
            However, if you receive a damaged, defective, or incorrect product, you may request a <strong className="font-semibold text-zinc-950">replacement (not a refund)</strong> by contacting us within <strong className="font-semibold text-zinc-950">48 hours of delivery</strong>.
          </p>
        ...
        >
          ...
          <p className="text-zinc-400 text-sm leading-relaxed mb-6 font-light">
            For return or replacement requests, please reach out to us:
          </p>
