...
const sections = [
  { id: 'definitions', title: '1. Definitions', content: 'Definitions used in this policy, including Data, Cookies, Matrix Tissue, and User.' },
  ...
  { id: 'security-data', title: '11. Security of Personal Data', content: 'Matrix Tissue uses standard security technologies and procedures to protect your Data from unauthorized access.' },
  ...
  { id: 'changes', title: '16. Changes to this Privacy Statement', content: 'Matrix Tissue reserves the right to change this Privacy Policy at any time. Changes will be posted on this website.' }
];
    ...
    <main className="bg-[#F8F9FA] text-[#161316] min-h-screen pb-24" style={{ fontFamily: '"Inter", sans-serif' }}>
      ...
      <div className="bg-[#161316] text-white py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            Your privacy is important to us. Matrix Tissue Private Limited (“Matrix Tissue”, “we” or “us”) takes the privacy of your personal information seriously.
          </motion.p>
        </div>
      </div>
