  ...
  return (
    ...
    >
      <head>
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-11248983982"
          strategy="afterInteractive"
        />
        ...
        <Script id="google-tag-manager" strategy="beforeInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-TMGDLKBR');
          `}
        </Script>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1864482081627803&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* End Meta Pixel Code */}
      ...
      <body className="min-h-screen">
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TMGDLKBR"
            height="0"
            width="0"
            style={{
              display: "none",
